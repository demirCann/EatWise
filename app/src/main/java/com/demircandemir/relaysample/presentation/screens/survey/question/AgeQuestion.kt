...
import com.demircandemir.relaysample.presentation.screens.survey.simpleDateFormatPattern
...
import com.demircandemir.relaysample.util.getDefaultDateInMillis
...
@Composable
fun AgeQuestionPreview() {

    RelaySampleTheme {
        Surface {
            AgeQuestion(
                titleResourceId = R.string.date_of_birth,
